...
public class buyuk_ekran_modelieskiActivity extends AppCompatActivity {
    private Toolbar toolbar;
    RecyclerView rv;
    private BuyukEkranModeliEskiAdapter adapter;
    private ArrayList<Gorevler> gorevArrayList;
    private Button buttonYeniGorevv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyuk_ekran_modelieski);
        ...
        adapter=new BuyukEkranModeliEskiAdapter(this,gorevArrayList);
