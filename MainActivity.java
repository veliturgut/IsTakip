...
public class MainActivity extends AppCompatActivity {
    ...
    private Button buttonBitenGörev;
...
//dd
        ...
        buttonBitenGörev=findViewById(R.id.buttonEskiiGörev);
  ...
  ;
        ...
        buttonBitenGörev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              Intent intent=new Intent(getApplicationContext(), EskiGorevler.class);
              startActivity(intent);
            }
        });


        adapter=new GorevAdapter(this,gorevArrayList);
