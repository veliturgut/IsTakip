...
public class YaziEkranModeliBitenActivity extends AppCompatActivity {
    RecyclerView rv;
    private YaziEkranModeliEskiAdapter adapter;
    private ArrayList<Gorevler> gorevArrayList;
    private Button buttonYeniEkranYazi;
    private Toolbar toolbar;
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yazi_ekran_modeli_biten);
...
//dd
        ...
        buttonYeniEkranYazi=findViewById(R.id.buttonYeniEkranYazi);
        buttonYeniEkranYazi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), YaziEkranModeliActivity.class);
        ...
        adapter=new YaziEkranModeliEskiAdapter(this,gorevArrayList);
